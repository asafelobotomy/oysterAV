...
GUI_CLIENT_TO_CLI: dict[str, list[str]] = {
    ...
    "terminal_list": ["terminal", "list", "--json"],
    "terminal_clear": ["terminal", "clear", "--help"],
    "terminal_export": ["terminal", "export", "--help"],
    "maintenance_post_update": ["maintenance", "post-update", "--help"],
    "firewall_status": ["firewall", "status", "--json"],
    "firewall_ensure_enable": ["firewall", "ensure-enable", "--help"],
    "firewall_set_enabled": ["firewall", "ensure-enable", "--help"],
    "firewall_select": ["firewall", "select", "--help"],
    "firewall_recommend": ["firewall", "recommend", "--help"],
    ...
    "firewall_firewalld_reload": ["firewall", "firewalld", "reload", "--help"],
    "firewall_firewalld_rich_rule": ["firewall", "firewalld", "rich-rule", "--help"],
    "fail2ban_unban": ["fail2ban", "unban", "--help"],
    "fail2ban_status": ["fail2ban", "status", "--json"],
    "fail2ban_banned": ["fail2ban", "banned", "--help"],
    "fail2ban_jail": ["fail2ban", "jail", "--help"],
    "fail2ban_jail_enable": ["fail2ban", "jail-control", "enable", "--help"],
    "fail2ban_jail_disable": ["fail2ban", "jail-control", "disable", "--help"],
    "fail2ban_reload": ["fail2ban", "reload", "--help"],
}
